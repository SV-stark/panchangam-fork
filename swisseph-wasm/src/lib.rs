...
pub mod swe_bindings {
    include!(concat!(env!("OUT_DIR"), "/bindings.rs"));
     // Manually declare functions that bindgen missed (Renamed)
    extern "C" {
        pub fn impl_swe_version(s: *mut i8) -> *mut i8;
        pub fn impl_swe_julday(year: i32, month: i32, day: i32, hour: f64, gregflag: i32) -> f64;
        pub fn impl_swe_calc_ut(tjd_ut: f64, ipl: i32, iflag: i32, xx: *mut f64, serr: *mut i8) -> i32;
        pub fn impl_swe_pheno_ut(tjd_ut: f64, ipl: i32, iflag: i32, attr: *mut f64, serr: *mut i8) -> i32;
        pub fn impl_swe_set_sid_mode(sid_mode: i32, t0: f64, ayan_t0: f64);
        pub fn impl_swe_get_ayanamsa_ut(tjd_ut: f64) -> f64;
        pub fn impl_swe_revjul(tjd: f64, gregflag: i32, year: *mut i32, month: *mut i32, day: *mut i32, hour: *mut f64);
        pub fn impl_swe_fixstar_ut(star: *mut i8, tjd_ut: f64, iflag: i32, xx: *mut f64, serr: *mut i8) -> i32;
        pub fn impl_swe_sidtime(tjd_ut: f64) -> f64;
        pub fn impl_swe_get_planet_name(ipl: i32, spname: *mut i8) -> *mut i8;
        pub fn impl_swe_set_topo(geolon: f64, geolat: f64, geoalt: f64);
    }
